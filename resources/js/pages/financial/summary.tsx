                                        ...
                                        <Card>
                                            ...
                                            <CardContent className="px-6">
                                                <div className="space-y-3">
                                                    ...
                                                    {/* Informação de Subsídio e Descontos */}
                                                    {(data.subsidies > 0 ||
                                                        data.discounts > 0) && (
                                                    ...
                                                    <BreakdownToggle
                                                        className="pt-2"
                                                        label="Descontos por marketplace"
                                                        items={
                                            ...
                                            <CardHeader className="px-6">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <CardTitle className="flex items-center gap-1.5 text-emerald-700">
                                                            (=) Receita pós
                                                            Dedução
                                                            <Tooltip
                                                                delayDuration={
